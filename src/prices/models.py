...
# BELARUS - сохранение данных для избегания повторных расчетов
FINAL_PARSED_DATA_FROM_SITES_WHOLE = 0
FINAL_PARSED_DATA_FROM_SITES = []
FINAL_PARSED_DATA_FROM_SITES_DATA = ''

BRANDS_FROM_SITES_DATE = ''
BRANDS_FROM_SITES = ''
TOP_BRANDS_NUM = 0

TYRESIZES_FROM_SITES_DATE = ''
TYRESITES_FROM_SITES = ''
TOP_TYRESIZES_NUM = 0

PERIOD_LIST_OF_PARSED_BRANDS_SITES_DICT = []
DATES_BRANDS_LIST_FOR_CHART_HEADER = []
TOP_BRANDS_NUM = 0
...
FINAL_PARSED_DATA_FROM_SITES_WHOLE_RUSSIA = 0
FINAL_PARSED_DATA_FROM_SITES_RUSSIA = []
FINAL_PARSED_DATA_FROM_SITES_DATA_RUSSIA = ''

BRANDS_FROM_SITES_DATE_RUSSIA = ''
BRANDS_FROM_SITES_RUSSIA = ''
TOP_BRANDS_NUM_RUSSIA = 0

TYRESIZES_FROM_SITES_DATE_RUSSIA = ''
TYRESITES_FROM_SITES_RUSSIA = ''
TOP_TYRESIZES_NUM_RUSSIA = 0

PERIOD_LIST_OF_PARSED_BRANDS_SITES_DICT_RUSSIA = []
DATES_BRANDS_LIST_FOR_CHART_HEADER_RUSSIA = []
TOP_BRANDS_NUM_RUSSIA = 0

PERIOD_LIST_OF_PARSED_TYRETYPES_DICT_RUSSIA = {}
DATES_TYRESIZES_LIST_FOR_CHART_HEADER_RUSSIA = []
SECOND_TOP_TYRESIZE_NUM_RUSSIA = 0
# END RUSSIA - сохранение данных для избегания повторных расчетов
